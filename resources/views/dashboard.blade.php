            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-3 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white shadow rounded-lg p-4">
                        <div class="text-sm font-medium text-gray-500"> <b>{{ __('sidebar.posts') }}</b></div>
                        <div class="text-2xl font-semibold text-gray-900">{{ $postCount }}</div>
                    </div>

                    <!-- Pages Card -->
                    <div class="bg-white shadow rounded-lg p-4">
                        <div class="text-sm font-medium text-gray-500"><b>{{ __('sidebar.pages') }}</b></div>
                        <div class="text-2xl font-semibold text-gray-900">{{ $pageCount }}</div>
                    </div>

                    <!-- Categories Card -->
                    <div class="bg-white shadow rounded-lg p-4">
                        <div class="text-sm font-medium text-gray-500"><b>{{ __('sidebar.category') }}</b></div>
